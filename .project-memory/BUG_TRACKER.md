...
| BUG-007 | Medium | Notification toggles (email/push) are local state only — reset on refresh, not persisted to backend | `settings/page.tsx` | Open — noted in UI as 'coming soon' | No |

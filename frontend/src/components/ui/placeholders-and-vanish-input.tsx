...
export function PlaceholdersAndVanishInput({
  ...
  const draw = useCallback(() => {
    ...
    try {
      ...
      // Handle environments without full Canvas ImageData support
      newDataRef.current = [];
    }
  }, [value]);
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute right-2 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full disabled:bg-gray-100 bg-black dark:bg-zinc-900 dark:disabled:bg-zinc-800 transition duration-200 flex items-center justify-center cursor-pointer disabled:cursor-not-allowed"
      >
        <motion.svg
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className="dark:text-zinc-400 text-sm sm:text-base font-normal text-neutral-500 pl-4 sm:pl-10 text-left w-[calc(100%-4rem)] truncate"
            >
